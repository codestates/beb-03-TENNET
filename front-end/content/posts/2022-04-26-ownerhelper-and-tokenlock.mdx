...
description: 관리자가 투표를 통해 Owner를 선정하고 변경하는 컨트랙트 작성해보기
seoDescription: 관리자가 투표를 통해 Owner를 선정하고 변경하는 컨트랙트 작성해보기
category: 'blockchain'
author:
  {
    nickname: 'chan',
...
<br/>
<img src='https://lh3.googleusercontent.com/YGJ77qN9KiwctZgfqV8Bf3hNo0rZvcFaPKDTkvtS6kVbtwyCS80Pm6dpXzJCCLZE1Q' width='100%' height='100%'/>

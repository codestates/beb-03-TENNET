...
description: The Longest Increasing Subsequence (LIS) problem is to find the length of the longest subsequence of a given sequence such that all elements of the subsequence are sorted in increasing order. .
seoDescription: The Longest Increasing Subsequence (LIS) problem is to find the length of the longest subsequence of a given sequence such that all elements of the subsequence are sorted in increasing order. .
...
image: 'https://prettygood236.github.io/assets/img/data-structures-and-algorithms/longest-subsequence/longest-subsequence_main.png'
---

<br/>

<img src='https://prettygood236.github.io/assets/img/data-structures-and-algorithms/longest-subsequence/longest-subsequence_main.png'/>
...
This problem has _<u>Obtimal Substructure</u>_ property and _<u>Overlapping Subproblem</u>_.It can be avoided by either using Memoization or Tabulation. => [Dynamic Programming](/data-structures-and-algorithms/dynamic-programming.html)

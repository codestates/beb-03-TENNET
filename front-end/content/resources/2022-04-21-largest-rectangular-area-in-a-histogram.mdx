...
description: Find the largest rectangular area possible in a given histogram where the largest rectangle can be made of a number of contiguous bars.
seoDescription: Find the largest rectangular area possible in a given histogram where the largest rectangle can be made of a number of contiguous bars.
category: 'data-structures-and-algorithms'
author:
  {
    nickname: 'chan',
    image: 'https://prettygood236.github.io/assets/img/id_pic.png',
  }
image: 'https://prettygood236.github.io/assets/img/data-structures-and-algorithms/largest-rectangular-area-in-a-histogram/largest-rectangular-area-in-a-histogram_main.png'
---

<br/>
<img src='https://prettygood236.github.io/assets/img/data-structures-and-algorithms/largest-rectangular-area-in-a-histogram/largest-rectangular-area-in-a-histogram_main.png'/>
...
<img src='https://prettygood236.github.io/assets/img/data-structures-and-algorithms/largest-rectangular-area-in-a-histogram/histogram_0.png'/>
...
We can use <b><u>Divide and Conquer</u></b> to solve this in $$O(nlogn)$$ time. The idea is to <u>find the minimum value</u> in the given array. Once we have index of the minimum value, the max area is maximum of following three values. <br/>
...
To find the minimum efficiently, Range Minimum Query using Segment Tree can be used for this. We build segment tree of the given histogram heights. Once the segment tree is built, all range minimum queries take $$O(logn)$$ time. So over all complexity of the algorithm becomes.<br/>
...
Divide and conquer based solution has the time complexity of $$O(nlogn)$$, but there is a way to reduce it to O(n).
